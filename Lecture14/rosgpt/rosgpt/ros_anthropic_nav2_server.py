...
class ROSAnthropicProxy(Resource):
    ...
    def ask_claude(self, text_command: str) -> Optional[str]:
        ...
        {"action": "follow_path", "params": {"locations": [{"type": "str", "value": location1}, {"type": "str", "value": location2}, ...]}}
        {"action": "sequence", "params": [{"action": "go_to_goal", "params": {"location": {"type": "str", "value": location}}}, ...], "continuous_path": true/false}
