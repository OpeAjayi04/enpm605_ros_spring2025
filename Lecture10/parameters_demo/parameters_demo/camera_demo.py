...
class CameraDemoNode(Node):
    ...
    def __init__(self):
        ...
        self._image_width = 640  # original width
        self._image_height = 480  # original height
    ...
    def _data_camera_pub_callback(self):
        ...
        self.get_logger().info(
            f"{Color.PURPLE}Published frame from:{Color.RESET} {Color.RED}{self._camera_name}{Color.RESET}"
        )
